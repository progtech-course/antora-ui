...
:page-authors: Author Name <email@example.com>; Second Author <https://website.com>
:idprefix:
:idseparator: -
:!example-caption:
:!table-caption:
...
Est in reque homero principes, meis deleniti mediocrem ad has.
Altera atomorum his ex, has cu elitr melius propriae.
Eos suscipit scaevola at. `some code`
[,python]
----
...
[NOTE]
====
You've been down _this_ road before. `some code`
[,python]
----
print(f"Hello world, {name}!")
----
...
[CAUTION]
====
[#inline]#I wouldn't try that if I were you.# `some code`
[,python]
----
print(f"Hello world, {name}!")
----
...
[IMPORTANT]
====
Don't forget this step! `some code`
[,python]
----
print(f"Hello world, {name}!")
----
